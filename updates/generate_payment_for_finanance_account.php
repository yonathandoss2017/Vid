<?php	
	...
	for($F=$From; $F <= $To; $F++){		
		...
		if($USD > 0.01){
			...
			$sql = "INSERT INTO vidoomy.closure (`publisher_id`, `payment_id`, `started_at`, `finished_at`, `usdamount`, `created_at`, `created_by`, `euramount`)
VALUES
($PubId, '', '$DFrom 00:00:00', '$DTo 23:59:59', '$USD', '$created_at', 4, $EUR);";
			
			echo $sql . "\n";
			
			$sql = "INSERT INTO `vidoomy`.`payment` (`currency_id`, `status`, `usdamount`, `created_at`, `created_by`, `year`, `month`, `estimated_payment_at`, `euramount`, `finance_account_id`) VALUES ('1', '1', '$USD', 'TIMESTAMP', '1', '2021', '$F', '', '$EUR', '$idAcc');";
