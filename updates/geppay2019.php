...
($PubId, '$DFrom 00:00:00', '$DTo 23:59:59', '$USD', '$created_at', 1, $EUR);";
			...
			$sql = "INSERT INTO `vidoomy`.`payment` (`currency_id`, `status`, `usdamount`, `created_at`, `created_by`, `year`, `month`, `estimated_payment_at`, `euramount`, `finance_account_id`) VALUES ('1', '1', '$USD', 'TIMESTAMP', '1', '2020', '$F', '', '$EUR', '$idAcc');";
