...
<body class="reports conqueror">
	<div class="container">
									...
									<tbody><?php
										...
										if($db->num_rows($query) > 0){
											while($DTag = $db->fetch_array($query)){
			            						...
			            						?><tr>
				            						<td style="background-color:#f8f8f8 !important;" id="tagname<?php echo $idDT; ?>"><?php echo $DTag['Name']; ?></td>
				            						<td style="background-color:#f8f8f8 !important;"><?php echo $Open; ?></td>
				            						<td style="background-color:#f8f8f8 !important;" id="tagid<?php echo $idDT; ?>"><?php echo $DTag['TagID']; ?></td>
				            						<td style="background-color:#f8f8f8 !important;" id="taglist<?php echo $idDT; ?>"><?php echo $ListID; ?></td>
				            						<td style="background-color:#f8f8f8 !important;" id="tagfill<?php echo $idDT; ?>"><?php echo $MinFill; ?></td>
				            						<td style="background-color:#f8f8f8 !important;" id="tagreq<?php echo $idDT; ?>"><?php echo $MinReq; ?></td>
				            						<td style="background-color:#f8f8f8 !important;" class="center">
					            						<?php if($DTag['Open'] != 1) { ?>
														<a href="javascript:void(0)" data-value="<?php echo $idDT; ?>" class="icon-small edit popup-trigger btn-edit-tag"></a>
														...
														<?php } else { ?>
														<a href="javascript:void(0)" data-value="<?php echo $idDT; ?>" class="icon-small edit popup-trigger btn-edit-tago"></a>
														<?php } ?>
													</td>
			            						</tr>
			            						<?php
		...
		<div class="popup-wrapper">
	        ...
	        <div class="popup-container popup-edit2">
	          <div class="popup-header">
	            <h4><span class="icon"></span>Editar Tag</h4>
	            <a href="javascript:void(0)" class="close-btn"></a>
	          </div>
	          <div class="popup-body">
	            <div class="info">
	              <h3 id="popwebname">Editar Tag <span id="edittagname"></span></h3>
	            </div>
	            <hr>
	            <form id="savetag">
				  <p class="check-message"></p>
	              ...
	              <div class="form-field">
	                <label for="line"><span class="required">*</span>Tag ID</label>
	                <input type="text" id="edit_tagid" name="tagid" class="onlynumber" style="width:140px;">
	              </div>
	              <div class="form-field">
	                <label for="line"><span class="required">*</span>Domain List ID</label>
	                <input type="text" id="edit_listid" name="listid" class="onlynumber" style="width:140px;">
	              </div>
	              <div class="form-field">
	                <label for="line"><span class="required"></span>Min. Fill</label>
	                <input type="text" id="edit_fill" name="fill" class="onlynumberdecimal" style="width:80px;">
	              </div>
	              <div class="form-field">
	                <label for="line"><span class="required"></span>Requests</label>
	                <input type="text" id="edit_requests" name="requests" class="onlynumber" style="width:80px;">
	              </div>        
					<hr>
					<div class="form-field">
						<div class="align-right">
							<a href="javascript:void(0)" class="btn btn-square close-btn">Cancelar</a>
							<a href="javascript:void(0)" class="btn btn-square flat-btn form-submit save-tag">Guardar cambios</a>
						</div>
					</div>
					<input type="hidden" value="" name="idtag" id="idtag">
					<input type="hidden" value="4" name="formtype">
	            </form>
	          </div>
	        </div>
	        <div class="popup-container popup-edit3">
	          <div class="popup-header">
	            <h4><span class="icon"></span>Editar Tag</h4>
	            <a href="javascript:void(0)" class="close-btn"></a>
	          </div>
	          <div class="popup-body">
	            ...
	            <form id="savetago">
	              ...
	              <div class="form-field">
	                <label for="divid"><span class="required">*</span>Nombre</label>
	                <input type="text" id="edit_descriptiono" name="description">
	              </div>
	              <div class="form-field">
	                <label for="line"><span class="required">*</span>Tag ID</label>
	                <input type="text" id="edit_tagido" name="tagid" class="onlynumber" style="width:140px;">
	              </div>
					<hr>
					<div class="form-field">
						<div class="align-right">
							<a href="javascript:void(0)" class="btn btn-square close-btn">Cancelar</a>
							<a href="javascript:void(0)" class="btn btn-square flat-btn form-submit save-tago">Guardar cambios</a>
						</div>
					</div>
					<input type="hidden" value="" name="idtag" id="idtago">
					<input type="hidden" value="5" name="formtype">
	            </form>
	          </div>
	        </div>
	    </div>       
