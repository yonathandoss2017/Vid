		...
		if(isset($_POST['password']) && isset($_POST['password2'])){
			if(strlen($_POST['password']) >= 8){
				if($_POST['password'] == $_POST['password2']){
					...
					$errorText = 'Password and Repeat Password does not match.';
					$error = true;
				}
			}else{
	...
	<div class="lgn-cn ctr b06c05d04">
		...
		<div class="bx-cn">
			...
			<div class="bx-bd"><?php
				...
				if($Expired){
					?><p style="text-align:center; padding-top:20px; padding-bottom:20px;">The code has expired.</p><?php
				}elseif($Changed){
					?><p style="text-align:center; padding-top:20px; padding-bottom:20px;">Password changed successfully.<br/><a href="/en/">Login</a></p><?php
				}else{
					?><form action="" method="post" class="frm-login">
						...
						<div class="frm-group">
	                        <input class="md-20 login-btn" type="submit" name="submit" value="Change Password" style="width: 100%" />
	                    </div>
					</form><?php
				}
			?></div>
