<?php	
	...
	<script>
		document.getElementById('tolog').submit();
			...
			$sql = "INSERT INTO login_en (idUser, Time, Date) VALUES ('$logID','" . time() . "','$date')";
			$db->query($sql);
								...
								<div class="ngrs-cn">
									...
									<div class="cngr-ft">
										<div>
											...
											<div class="numb-2 padbt-20"><?php echo $RevenueThisMonthShow; ?><?php /* <span class="fa-chevron-circle-up mr1">+23%</span> */ ?></div>
										</div>
									</div>
						...
						?></button>
								<div class="dropdown-menu">											
									<div class="fs-dropdown-options bx-cn">
										<span class="fs-dropdown-group">Select Dates</span>
											...
											<button type="button" class="fs-dropdown-item" data-value="3" onclick="location.href='stats.php?range=thismonth<?php echo $andv; ?>'">Current Month</button>
					...
					<div class="bx-bd">
						<div class="bx-pd">
							<ul class="lst-tbs b-fx mb2">
								<li<?php echo $view1; ?>><a href="stats.php?<?php echo $andr; ?>view=1">Stats</a></li><?php
								if($ShowPL){
								?><li<?php echo $view2; ?>><a href="stats.php?<?php echo $andr; ?>view=2" class="fa-android">Plataform</a></li><?php
								}
								if($ShowST){
							...
							<div class="tbl-cn">
								<table id="tbl-estats">
									...
									<tbody>
										...
										<tfoot>
										<tr>
											<th colspan="2"><span>Total: <?php if($ShowCPM){ ?>Impressions:</span> <strong><?php echo number_format($TotalImpressions, 0, ',', '.'); ?></strong></span> <span class="txspr">·</span> <!--<span>% de Conversiones: <strong>1.19%</strong></span> <span class="txspr">·</span>--> <span>CPM: <strong><?php echo $totaleCpmShow; ?></strong></span> <span class="txspr">·</span><?php } ?> <span>Revenue: <strong><?php echo $DE . number_format($TotalRevenue, 2, ',', '.') . $DEb; ?></strong></span></th>
										</tr>
										</tfoot>
								</table>
							</div>
