			...
			if($siteId > 0){
				...
				if($db->num_rows($query) > 0){
					...
					if(isset($_POST['save'])){
						...
						if($_POST['save'] != ''){
							if($_POST['sitename'] != ''){
								$sql = "UPDATE " . SITES . " SET sitename = '$sitename', category = '$category' WHERE id = '$siteId' AND idUser = '" . $_SESSION['login'] . "' LIMIT 1";
								$db->query($sql);
							}else{
					...
					<main class="clmc12 c-flx1">
						...
						<div class="bx-cn bx-shnone">
							<div class="bx-hd dfl b-fx">
								<div class="titl">Edit Website</div>
							</div>
							<div class="bx-bd">
								<div class="bx-pd">
									<form action="" method="post" class="frm-adrsit">
										<div class="bx-hd dfl b-fx">
											<div class="titl">Edit Site</div>
										</div>
										<div class="clsd-fx">
											<div class="clmd06">
												<!--<Nombre Web>-->
												<div class="frm-group d-fx lbl-lf<?php echo $nameErrorc; ?>">
													<label<?php echo $nameErrors; ?>>Site</label>
													<div class="d-flx1">
											...
											<div class="clmd06">
												<div class="frm-nln">Type of content 
										...
										<div class="botnr-cn">
											<input type="submit" class="fa-save" value="Save" name="save" />
										</div>
									</form>
								</div>
							</div>
