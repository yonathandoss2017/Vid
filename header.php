		...
		<header class="hdcn">
			<div class="cnt a-fx">			
				<div class="logo">
					<a href="/stats.php"><img src="/img/vidoomy-logo.png" class="mh-logo" alt="vidoomy"></a>
				</div>
				<nav class="mn-user a-flx1">
					<ul class="0-fx">
						...
						<li class="op-user 0-fx 0-rt hidden-xs menu-r">
                            <a href="my-account.php"><i class="material-icons">settings</i><span>Mi Cuenta</span></a><?php /* <a href="#"><i class="material-icons">euro_symbol</i><span>Facturación</span></a> */ ?>

                            <a href="stats.php"><i class="material-icons">pie_chart</i><span>Estadisticas</span></a>
                            <a href="sites.php"><i class="material-icons">create_new_folder</i><span>Sitios</span></a>
                            <a href="logout.php"><i class="material-icons">power_settings_new</i><span>Desconectar</span></a>
                            <?php /*
