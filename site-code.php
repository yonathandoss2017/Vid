...
/*
$adstxt = 'vidoomy.com, 183'.$_SESSION['login'].", DIRECT 
									...
									<ul class="lst-codg">
										<li>
											<div class="b-fx">
												...
												<div class="b-flx1">
													Código:<br/>
													<textarea cols="66" rows="6">&#60;script type="text/javascript" src="<?php echo str_replace('http://',"//",$siteData['filename']); ?>" async&#62;&#60;/script&#62;</textarea>
													<button class="btn-blk fa-copy" onclick="copiarAlPortapapeles2('textatc2')">Click aqui para copiar el código</button>
													...
													<button class="btn-blk fa-copy" onclick="copiarAlPortapapeles('textatc')">Click aqui para copiar ads.txt</button>
