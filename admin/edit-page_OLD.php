					...
					if($_POST['save'] != ''){
						...
						if($_POST['sitename'] != ''){
							...
							if($_POST['siteurl'] != ''){
								...
								$sql = "UPDATE " . SITES . " SET siteurl = '$siteurl', sitename = '$sitename', category = '$category', idUser = '$newUser' WHERE id = '$siteId' LIMIT 1";
								$db->query($sql);
												...
												?><tr>
													...
													<td data-title="Opciones">
														<ul class="lst-opt">
															...
															<li><a href="edit-page.php?idpage=<?php echo $siteId; ?>&del=<?php echo $Code['id']; ?><?php echo $linkAnd; ?>" onclick="return confirm('¿Esta seguro de eliminar esta exepci&oacute;n? La misma no podrá ser recuperada')" class="fa-trash-o tt-lt" data-toggle="tooltip" title="" data-original-title="Eliminar Codigo"></a></li>
														</ul>
													</td>
												</tr><?php
											}
