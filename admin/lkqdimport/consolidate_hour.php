<?php	
	...
	echo $DateS = date('Y-m-d', time() - 1200);
	echo $Hi = intval(date('H', time() - 1200));
	
	$sql = "TRUNCATE reports_consolidate_hour";
	$db->query($sql);
	...
	*/
	...
	$sql = "SELECT * FROM reports_consolidate_hour ORDER BY id ASC";
	$query = $db->query($sql);
