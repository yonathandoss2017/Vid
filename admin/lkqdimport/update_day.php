<?php	
	...
	$sql = "SELECT COUNT(*) FROM reports_last_day";
	$Tot = $db->getOne($sql);
	$Count = 0;
	$ST = 0;
	while($Count < $Tot){
		$sql = "SELECT * FROM reports_last_day ORDER BY id ASC LIMIT $Count , 1000";
		$query = $db->query($sql);
