						...
						if($_POST['sitename'] != ''){
							if($_POST['siteurl'] != ''){
								...
								*/
								...
								$sql = "UPDATE " . SITES . " SET siteurl = '$siteurl', sitename = '$sitename', category = '$category', test = '$test' WHERE id = '$siteId' LIMIT 1";
								$db->query($sql);
								
								$sql = "UPDATE website SET url = '$siteurl', sitename = '$sitename', content_type = '$category', is_test_mode = '$test' WHERE id = '$siteId' LIMIT 1";
								$db2->query($sql);
									...
									<form action="" method="post" class="frm-adrsit">
										...
										<div class="clsd-fx">
												...
												<div class="frm-group d-fx lbl-lf<?php echo $userErrorc; ?>">
													...
													<div class="d-flx1">
														<label<?php echo $userError; ?>>
															<select name="user" id="user" disabled="disabled" data-dropdown-options='{"customClass":"slct-hd", "label":"Seleccionar"}'>
											...
											<div class="clmd12">
												<!--<Script>-->
												<div class="frm-group d-fx lbl-lf">
													<label style="margin-top:-18px;">Modo test</label>
													<input type="checkbox" value="1" name="test"<?php if($siteData['test'] == 1){ echo ' checked="checked"'; } ?> />
												</div>
												<!--</Script>-->
											</div>
											<?php
