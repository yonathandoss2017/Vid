		...
		if(isset($_POST['update'])){
			if($_POST['update'] == 1){
				...
				if($sigue){
					$time = time();
					$date = date('Y-m-d');
					$sql = "INSERT INTO " . USERS . " (user, password, email, name, lastname, phone, movil, whatsapp, sykpe, ef, nifcif, company, country, province, city, cp, address, paymenttype, account, amount, swift, currency, LKQD_id, SS_id, lastlogin, image, remember, showi, AccM, deleted, time, date) 
						VALUES ('$user', '$newpassword','$email', '$name', '$lastname', '$phone', '$movil', '$whatsapp', '$sykpe', '$ef', '$nif', '$company', '$country', '$province', '$city', '$cp', '$address', '$paymenttype', '$account', '$amount', '$swift', '$currency', '$lkqd', '$springserver', '0', '', '$remember', '$showi', '$accm', 0, '$time', '$date')";
					$db->query($sql);
		                                    ...
		                                    <div id="fragment-3">
												...
												<div class="bx-hd dfl b-fx">
													...
													<div class="clsd-fx">
														...
														<!--</Moneda>-->
														<!--<SWIFT>-->
														<div class="clmd06" id="showswift"<?php if($paymenttype != 2) { echo ' style="display:none"';} ?>>
