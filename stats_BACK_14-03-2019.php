						...
						<div class="bx-cn bx-shnone">
							...
							<div class="bx-bd">
								<div class="ngrs-cn">
                                    ...
                                    <br /><br /><br />
                                    <?php /* <a href="#" class="btn-hd-ref mat-record_voice_over">Ver Referidos</a> */ ?>
								</div>
							</div>
						</div>
						<!--</Cuenta de Ingresos>-->
					...
					<!--<Estadisticas Avanzadas>-->
						<div class="bx-cn bx-shnone">
							<div class="bx-hd dfl b-fx bghd-e">
								...
								<?php /* <a href="#" class="btn-hd fa-group mat-record_voice_over b-rt btn-nbd">Ir a Referidos</a> */ ?>								
							</div>
							<div class="bx-bd">
								<div class="bx-pd">
									<div class="bx-hd dfl b-fx">
							...
							<div class="tbl-cn">
								<table id="tbl-estats">
									...
									<tbody>
										...
										<tfoot>
										<tr>
											<th colspan="4"><span>Totales: <?php if($ShowCPM){ ?>Impresiones:</span> <strong><?php echo number_format($TotalImpressions, 0, ',', '.'); ?></strong></span> <span class="txspr">·</span> <!--<span>% de Conversiones: <strong>1.19%</strong></span> <span class="txspr">·</span>--> <span>CPM: <strong><?php echo $totaleCpmShow; ?></strong></span> <span class="txspr">·</span><?php } ?> <span>Ganancias: <strong><?php echo $DE . number_format($TotalRevenue, 2, ',', '.') . $DEb; ?></strong></span></th>
										</tr>
										</tfoot>
									</tbody>
								</table>
