						...
						<div class="results-showing" style="width: 100%;">
							<table id="report-table" class=" panel-table" style="width:100%"><?php
								if($Sites){
									...
									$JsonData = file_get_contents('http://pix.vidoomy.com/toystory/events.php');
									$EventsData = json_decode($JsonData);
									
									$EventsList['loaded'] = 'Loaded';
									$EventsList['screen'] = 'On Screen';
									$EventsList['landing'] = 'Landing Click';
									$EventsList['close'] = 'Close Click';
									$EventsList['video1'] = 'Video 1';
									$EventsList['video2'] = 'Video 2';
									$EventsList['video3'] = 'Video 3';
									$EventsList['click'] = 'Comprar Entradas';
									$EventsList['video_achica'] = 'Video Achicado';
