<?php	
	...
	$JsonData = file_get_contents('http://pix.vidoomy.com/declarando/events.php');
				  ...
				  <div class="results">
						<div class="results-showing" style="width: 100%; overflow: auto;">
							<table id="report-table" class=" panel-table" style="width:100%"><?php
									...
									$EventsList['click1'] = 'Empieza Gratis';
									$EventsList['click2'] = 'Declarando';
									$EventsList['click3'] = 'Ventajas';
									$EventsList['twitter'] = 'Twitter';
									$EventsList['facebook'] = 'Facebook';
									$EventsList['formerror'] = 'Formulario Error';
									$EventsList['sendform'] = 'Formulario';
